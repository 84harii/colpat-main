...
export default function PaletteFromColor() {
  ...
  return (
    <>
      <Head>
        <title>Coolerss : Color Palette from Color [AI]</title>
        <meta name="title" content="Coolerss : Color Palette from Color [AI]" />
        <meta
          name="description"
          content="Coolerss's Color Palette from Color [AI] feature allows you to generate a color palette from a single color. Just tell Coolerss about the color you want to use, and it will generate the best color palette for you. This feature is useful when you have a specific color in mind and want to build a palette around it."
        />

        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://Coolerss.itsvg.in/palette-from-color"
        />
        <meta
          property="og:title"
          content="Coolerss : Color Palette from Color [AI]"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://Coolerss.itsvg.in/assets/6.png"
        />
