...
export default function Tpg() {
  ...
  return (
    <>
      <Head>
        <title>Coolerss : TailwindCSS Palette Generator</title>
        <meta name="title" content="Coolerss : TailwindCSS Palette Generator" />
        <meta
          name="description"
          content="Coolerss's Tailwind Palette Generator feature is specifically designed for developers who use Tailwind CSS. With just a click, you can generate color palettes for your next Tailwind-powered project. This feature saves you time and effort in selecting colors that match Tailwind's design system."
        />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://Coolerss.itsvg.in/tpg" />
        <meta
          property="og:title"
          content="Coolerss : TailwindCSS Palette Generator"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://Coolerss.itsvg.in/assets/8.png"
        />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://Coolerss.itsvg.in/tpg" />
        <meta
